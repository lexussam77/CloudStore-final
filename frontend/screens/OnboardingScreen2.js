  ...
  return (
    <LinearGradient colors={DEEP_BLUE_GRADIENT} style={{ flex: 1 }}>
      <SafeAreaView style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 24 }}>
        ...
        <TouchableOpacity style={{ backgroundColor: BLUE_ACCENT, borderRadius: 22, paddingVertical: 18, alignItems: 'center', width: '100%', shadowColor: BLUE_ACCENT, shadowOpacity: 0.12, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 2 }} activeOpacity={0.85} onPress={() => navigation.navigate('Onboarding3')}>
